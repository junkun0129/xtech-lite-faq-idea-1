...
export const AnnouncementIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M4 4h16v12H4z"></path><path d="M4 10h16"></path><path d="M8 10v6"></path><path d="M16 10v6"></path><path d="M12 10v6"></path><path d="M9 4v-2"></path><path d="M15 4v-2"></path>
  </svg>
);
...
export const SortAscendingIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M3 4h18M3 8h12M3 12h8M18 16l-3 3-3-3m3 3V4"/>
    </svg>
);