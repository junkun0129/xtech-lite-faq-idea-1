...
const Leaderboard: React.FC = () => {
  return (
    <div className="w-full lg:w-80 flex-shrink-0">
        <div className="bg-[#fcfcff] border border-gray-200 rounded-lg p-4 sticky top-24">
            <h3 className="font-bold text-lg mb-4 text-gray-800">回答者ランキング</h3>
            <ul className="space-y-3">
                {RANKED_USERS.map((user, index) => (
                    <li key={user.id} className="flex items-center gap-4 p-2 rounded-md hover:bg-[#f0fafa]">
